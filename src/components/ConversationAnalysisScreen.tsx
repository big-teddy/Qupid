...
import { Persona, ConversationAnalysis } from '../types';
import { TargetIcon, TrendingUpIcon, ArrowLeftIcon } from './Icons';
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#F9FAFB]">
        <header className="flex-shrink-0 p-5 pt-6 text-center relative">
            <button onClick={onNext} className="absolute left-3 top-4 p-2 rounded-full hover:bg-gray-100">
