        ...
        <div className="flex flex-col h-full w-full bg-[#F9FAFB]">
            ...
            <main className="flex-1 overflow-y-auto p-4">
                ...
                <SectionContainer title="개인 정보">
                    ...
                    <SettingItem icon="🚻" title="성별 변경" onClick={() => {}} rightComponent={<><span className="text-base font-medium">{userProfile.userGender === 'male' ? '남성' : '여성'}</span><ChevronRightIcon className="w-4 h-4" /></>} />
