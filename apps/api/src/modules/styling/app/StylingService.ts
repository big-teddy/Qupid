        ...
        messages: [
          {
            role: "system",
            content:
              "You are a professional fashion stylist. Provide styling advice that is specific, encouraging, and easy to understand. Respond in Korean.",
          },
          {
            role: "user",
