...
router.get("/dashboard", coachingController.getUserDashboard);
router.post("/goals", coachingController.createGoal);
router.patch("/goals/:goalId", coachingController.updateGoal);
...
router.post(
  ...
  coachingController.sendCoachingMessage,
);
router.get(
  "/sessions/:sessionId/stream",
  coachingController.streamCoachingMessage,
);
