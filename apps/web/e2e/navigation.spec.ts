...
test.describe("Navigation", () => {
  ...
  test("should navigate between tabs", async ({ page }) => {
    // 홈 탭 확인
    await expect(page.locator('[data-testid="tab-home"]')).toHaveClass(
      /active/,
    );
    ...
    await expect(page.locator('[data-testid="tab-performance"]')).toHaveClass(
      /active/,
    );
    ...
    await expect(page.locator('[data-testid="tab-coaching"]')).toHaveClass(
      /active/,
    );
  ...
  test("should filter personas by gender", async ({ page }) => {
    ...
    const maleCount = await page
      .locator('[data-testid*="persona-card"]')
      .count();
