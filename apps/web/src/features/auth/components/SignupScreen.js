...
const SignupScreen = ({ onSignupSuccess }) => {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("header", {
        className:
          "bg-white px-6 py-4 border-b border-[#E5E8EB] flex items-center",
        children: [
          _jsx("button", {
      ...
      _jsxs("div", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx("div", {
                className: `flex-1 h-1 rounded-full ${step >= 1 ? "bg-[#F093B0]" : "bg-[#E5E8EB]"}`,
              }),
              _jsx("div", {
                className: `flex-1 h-1 rounded-full ${step >= 2 ? "bg-[#F093B0]" : "bg-[#E5E8EB]"}`,
              }),
            ],
          }),
          _jsx("p", {
            className: "text-sm text-[#8B95A1] mt-2",
            children: step === 1 ? "기본 정보 입력" : "성별 선택",
          }),
        ],
      }),
      _jsxs("main", {
        ...
        children: [
                ...
                children: [
                  _jsxs("div", {
                    children: [
                      _jsx("label", {
                        className:
                          "block text-sm font-medium text-[#191F28] mb-2",
                        children: "\uC774\uB984",
                      }),
                      _jsx("input", {
                        type: "text",
                        ...
                        placeholder:
                          "\uC774\uB984\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694",
                        className:
                          "w-full h-14 px-4 rounded-xl border border-[#E5E8EB] focus:border-[#F093B0] focus:outline-none text-base",
                      }),
                    ],
                  }),
                  _jsxs("div", {
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsxs("div", {
                    children: [
                      _jsx("h2", {
                        className: "text-xl font-bold text-[#191F28] mb-4",
                        children: "\uB2F9\uC2E0\uC758 \uC131\uBCC4\uC740?",
                      }),
                      _jsxs("div", {
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx("div", { className: "flex-1 h-px bg-[#E5E8EB]" }),
              _jsx("span", {
                className: "px-4 text-sm text-[#8B95A1]",
                children: "\uB610\uB294",
              }),
              _jsx("div", { className: "flex-1 h-px bg-[#E5E8EB]" }),
            ],
          }),
          _jsx(SocialLoginButtons, {}),
        ],
      }),
      _jsx("div", {
        className: "px-6 pb-8",
