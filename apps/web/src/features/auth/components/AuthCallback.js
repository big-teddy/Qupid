    ...
    return _jsx("div", {
      ...
      children: _jsxs("div", {
        ...
        children: [
          _jsx("div", {
            className:
              "w-16 h-16 border-4 border-[#F093B0] border-t-transparent rounded-full animate-spin mx-auto mb-4",
          }),
          _jsx("p", {
    ...
    return _jsx("div", {
      ...
      children: _jsxs("div", {
        ...
        children: [
          ...
          _jsx("p", { className: "text-[#8B95A1] mb-6", children: error }),
          _jsx("button", {
            onClick: () => navigate("/login"),
            className:
              "w-full h-14 bg-[#F093B0] text-white font-bold rounded-xl hover:bg-[#E881A5] transition-all",
            children: "\uB2E4\uC2DC \uB85C\uADF8\uC778\uD558\uAE30",
          }),
        ],
      }),
