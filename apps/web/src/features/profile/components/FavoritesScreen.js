...
const FavoritesScreen = ({ personas, onSelectPersona, onBack }) => {
  return _jsxs("div", {
    ...
    children: [
      _jsxs("header", {
        ...
        children: [
          ...
          _jsx("button", {
            className:
              "p-2 w-14 rounded-full text-[#4F7ABA] font-semibold text-base",
            children: "\uD3B8\uC9D1",
          }),
        ],
      }),
                ...
                children: personas.map((persona) =>
                  _jsxs(
                    "li",
                    {
                      ...
                      className:
                        "p-4 flex items-center cursor-pointer hover:bg-gray-50",
                      children: [
                        _jsx("img", {
                          src: persona.avatar,
                          alt: persona.name,
                        ...
                        _jsx("button", {
                          ...
                          className:
                            "px-4 py-2 bg-[#F093B0] text-white text-sm font-bold rounded-full",
                          children: "\uB300\uD654\uD558\uAE30",
                        }),
                      ],
                    },
