...
const SectionContainer = ({ title, children, className }) =>
  _jsxs("div", {
    ...
    children: [
      title &&
        _jsx("h3", {
          className: "px-5 pb-1 text-base font-bold text-[#8B95A1]",
          children: title,
        }),
      _jsx("div", {
        className:
          "bg-white rounded-2xl border border-[#F2F4F6] overflow-hidden divide-y divide-[#F2F4F6]",
        children: children,
      }),
    ],
  });
const MyTabScreen = ({ onLogout, isGuest }) => {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("header", {
        className: "flex-shrink-0 p-4 pt-5 bg-white",
        children: _jsx("h1", {
        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              _jsx("div", {
                className:
                  "w-16 h-16 rounded-full bg-[#F093B0] flex items-center justify-center text-white text-3xl font-bold",
                children: initial,
              }),
              _jsxs("div", {
                ...
                children: [
                  _jsxs("p", {
                    ...
                    children: [
                      ...
                      isGuest &&
                        _jsx("span", {
                          className: "ml-2 text-xs text-[#F093B0]",
                          children: "(\uC784\uC2DC)",
                        }),
                    ],
                  }),
                  _jsx("p", {
                    className: "font-medium text-sm text-[#8B95A1]",
                    children: isGuest ? "체험 중" : "Level 3 · 대화 중급자",
                  }),
                  !isGuest &&
                    _jsx("div", {
                      className: "mt-1.5 h-1 w-full bg-white/30 rounded-full",
                      children: _jsx("div", {
              ...
              !isGuest &&
                _jsx("button", {
                  ...
                  className:
                    "h-8 px-4 rounded-lg bg-white/20 border border-white/30 text-[#4F7ABA] text-sm font-bold",
                  children: "\uD3B8\uC9D1",
                }),
              isGuest &&
                _jsx("button", {
                  ...
                  className:
                    "h-8 px-4 rounded-lg bg-[#F093B0] text-white text-sm font-bold",
                  children: "\uD68C\uC6D0\uAC00\uC785",
                }),
            ],
          }),
          isGuest &&
            _jsxs("div", {
              className: "bg-[#FFF5F7] border border-[#FFE0E6] rounded-2xl p-4",
              children: [
                _jsx("p", {
                  className: "text-sm font-bold text-[#F093B0] mb-2",
                  children:
                    "\uD83C\uDF81 \uAC8C\uC2A4\uD2B8 \uCCB4\uD5D8 \uC911",
                }),
                _jsxs("p", {
                  className: "text-xs text-[#8B95A1] mb-3",
                  children: [
                    "\uB0A8\uC740 \uB300\uD654 \uD69F\uC218:",
                    " ",
                    Math.max(
                      0,
                      3 -
                        parseInt(localStorage.getItem("guestChatCount") || "0"),
                    ),
                    "/3\uD68C",
                  ],
                }),
                _jsx("button", {
                  onClick: () => navigate("/signup"),
                  className:
                    "w-full h-10 bg-[#F093B0] text-white rounded-lg font-bold text-sm",
                  children:
                    "\uD68C\uC6D0\uAC00\uC785\uD558\uACE0 \uBAA8\uB4E0 \uAE30\uB2A5 \uC0AC\uC6A9\uD558\uAE30",
                }),
              ],
          ...
          _jsxs(SectionContainer, {
            ...
            children: [
              _jsx(SettingItem, {
                icon: "\uD83D\uDCDA",
                title: "\uD559\uC2B5 \uBAA9\uD45C \uC124\uC815",
                onClick: () => handleRestrictedNavigate("/coaching/goals"),
                rightComponent: _jsxs(_Fragment, {
                  children: [
                    _jsx("span", {
              ...
              _jsx(SettingItem, {
                ...
                rightComponent: _jsx(TossToggle, {
                  value: practiceNotification,
                  onToggle: () => setPracticeNotification((v) => !v),
                }),
              }),
            ],
          }),
          ...
          _jsx(SectionContainer, {
            ...
            children: _jsx(SettingItem, {
              ...
              rightComponent: _jsx(ChevronRightIcon, { className: "w-4 h-4" }),
            }),
          }),
          _jsxs(SectionContainer, {
            title: "\uACE0\uAC1D \uC9C0\uC6D0",
            children: [
              _jsx(SettingItem, {
                ...
                title: "\uB3C4\uC6C0\uB9D0",
                onClick: () => {},
                rightComponent: _jsx(ChevronRightIcon, {
                  className: "w-4 h-4",
                }),
              }),
              _jsx(SettingItem, {
