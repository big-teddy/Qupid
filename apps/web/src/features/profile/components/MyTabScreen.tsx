...
const SectionContainer: React.FC<{
  ...
  <div className={`mt-4 ${className}`}>
    {title && (
      <h3 className="px-5 pb-1 text-base font-bold text-[#8B95A1]">{title}</h3>
    )}
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-24">
        ...
        >
          ...
          <div className="ml-4 flex-1">
            <p className="font-bold text-xl text-[#191F28]">
              ...
              {isGuest && (
                <span className="ml-2 text-xs text-[#F093B0]">(임시)</span>
              )}
            </p>
          ...
          {isGuest && (
            <button
              ...
              className="h-8 px-4 rounded-lg bg-[#F093B0] text-white text-sm font-bold"
            >
              회원가입
            </button>
          )}
        ...
        {isGuest && (
          <div className="bg-[#FFF5F7] border border-[#FFE0E6] rounded-2xl p-4">
            <p className="text-sm font-bold text-[#F093B0] mb-2">
              🎁 게스트 체험 중
            </p>
            <p className="text-xs text-[#8B95A1] mb-3">
              ...
              {Math.max(
                0,
                3 - parseInt(localStorage.getItem("guestChatCount") || "0"),
              )}
              /3회
            </p>
            <button
        ...
        <SectionContainer title="학습 설정">
          <SettingItem
            ...
            rightComponent={
              <>
                <span className="text-sm font-medium">일 3회 대화</span>
          ...
          <SettingItem
            ...
            rightComponent={
              <>
                <span className="text-sm font-medium">게임, 영화 외 3개</span>
                <ChevronRightIcon className="w-4 h-4" />
              </>
            }
          />
        ...
        <SectionContainer title="앱 설정">
          <SettingItem
            ...
            rightComponent={
              <>
                <span className="text-sm font-medium">모두 허용</span>
                <ChevronRightIcon className="w-4 h-4" />
              </>
            }
          />
        ...
        <SectionContainer title="고객 지원">
          ...
          <SettingItem
            icon="📄"
            title="버전 정보"
            rightComponent={<span className="text-sm font-medium">v1.2.3</span>}
          />
        </SectionContainer>
