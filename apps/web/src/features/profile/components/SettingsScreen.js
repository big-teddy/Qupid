...
const SettingsScreen = ({ onBack, onLogout, }) => {
    ...
    if (showNotificationSettings) {
        return (_jsx(NotificationSettingsScreen, { onBack: () => setShowNotificationSettings(false), notificationTime: notificationTime, doNotDisturbStart: doNotDisturbStart, doNotDisturbEnd: doNotDisturbEnd, onSave: (nt, start, end) => handleNotificationTimeSave(nt, start, end) }));
    }
    // Helper for logout
    const handleLogout = () => {
    ...
    return (_jsxs("div", { className: "flex flex-col h-full w-full bg-[#F9FAFB]", children: [_jsxs("header", { className: "flex-shrink-0 flex items-center justify-between p-3 bg-white", children: [_jsx("button", { onClick: onBack, className: "p-2 rounded-full hover:bg-gray-100", children: _jsx(ArrowLeftIcon, { className: "w-6 h-6 text-[#191F28]" }) }), _jsx("h1", { className: "text-xl font-bold text-[#191F28]", children: "\uC124\uC815" }), _jsx("div", { className: "w-10" })] }), _jsxs("main", { className: "flex-1 overflow-y-auto p-4", children: [_jsxs("div", { className: "h-[120px] rounded-2xl p-5 flex items-center text-white", style: { background: "linear-gradient(135deg, #FDF2F8, #EBF2FF)" }, children: [_jsx("div", { className: "w-16 h-16 rounded-full bg-[#F093B0] flex items-center justify-center text-white text-3xl font-bold", children: initial }), _jsxs("div", { className: "ml-4 flex-1", children: [_jsx("p", { className: "font-bold text-xl text-[#191F28]", children: userProfile.name }), _jsxs("p", { className: "font-medium text-sm text-[#8B95A1]", children: ["Level ", userProfile.confidence || 1, " \u00B7 ", userProfile.experience || "초급"] }), _jsx("div", { className: "mt-1.5 h-1 w-full bg-white/30 rounded-full", children: _jsx("div", { className: "h-1 rounded-full bg-[#F093B0]", style: { width: "75%" } }) })] }), _jsx("button", { onClick: () => navigate("/my/profile"), className: "h-8 px-4 rounded-lg bg-white/20 border border-white/30 text-[#4F7ABA] text-sm font-bold", children: "\uD3B8\uC9D1" })] }), _jsxs(SectionContainer, { children: [_jsx(SettingItem, { icon: "\uD83D\uDCDA", title: "\uD559\uC2B5 \uBAA9\uD45C \uC124\uC815", onClick: () => navigate("/coaching/goals"), rightComponent: _jsxs(_Fragment, { children: [_jsx("span", { className: "text-base font-medium", children: "\uC77C 3\uD68C \uB300\uD654" }), _jsx(ChevronRightIcon, { className: "w-4 h-4" })] }) }), _jsx(SettingItem, { icon: "\uD83C\uDFAF", title: "\uAD00\uC2EC \uBD84\uC57C \uC218\uC815", onClick: () => navigate("/my/profile"), rightComponent: _jsxs(_Fragment, { children: [_jsx("span", { className: "text-base font-medium", children: userProfile.interests && userProfile.interests.length > 0
                                    ...
                                    }, dangerous: true, rightComponent: _jsx(ChevronRightIcon, { className: "w-4 h-4" }) }), _jsx(SettingItem, { icon: "\u274C", title: "\uD68C\uC6D0 \uD0C8\uD1F4", subtitle: "\uBAA8\uB4E0 \uB370\uC774\uD130\uAC00 \uC0AD\uC81C\uB429\uB2C8\uB2E4", onClick: () => navigate("/settings/delete"), dangerous: true, rightComponent: _jsx(ChevronRightIcon, { className: "w-4 h-4" }), isLast: true })] }) })] })] }));
};
