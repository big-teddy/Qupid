  ...
  if (step === "final") {
    return (
      <div className="flex flex-col h-full w-full bg-white justify-center items-center text-center p-8 animate-fade-in">
        ...
        <h1 className="mt-6 text-3xl font-bold text-[#191F28]">
          아쉽지만 안녕히 가세요
        </h1>
        <p className="mt-3 text-base text-[#8B95A1]">
          언제든 다시 돌아와 주세요.
          <br />더 나은 모습으로 기다리고 있을게요.
        </p>
        <button
          onClick={onComplete}
          className="mt-8 w-full max-w-xs h-14 bg-[#F093B0] text-white text-lg font-bold rounded-xl"
        >
          앱 종료하기
        </button>
      </div>
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        >
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h2 className="font-bold text-lg text-[#FF4757]">
                정말 탈퇴하시겠어요?
              </h2>
        ...
        <section className="p-4 bg-white rounded-2xl border border-[#F2F4F6]">
          ...
          <p className="text-sm text-[#8B95A1] px-3 mt-1">
