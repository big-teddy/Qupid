        ...
        try {
            if (category === "custom") {
                ...
                const persona = {
                    ...
                    mbti: result.personality || "ENFP",
                    intro: result.conversationStyle ||
