...
export const StyleRecommendationModal = ({
  isOpen,
  onClose,
  analysis,
  isLoading,
      ...
      children: [
            ...
            : analysis
              ? _jsxs("div", {
                  ...
                  children: [
                    _jsxs("div", {
                      className:
                        "bg-gradient-to-r from-pink-50 to-purple-50 p-4 rounded-xl",
                      children: [
                        _jsxs("h3", {
                          className: "font-bold text-lg mb-2",
                          children: [
                            "\uB2F9\uC2E0\uC758 \uB300\uD654 \uC2A4\uD0C0\uC77C: ",
                            analysis.currentStyle.type,
                          ],
                        }),
                        _jsxs("div", {
                          className: "space-y-2",
                                    ...
                                    analysis.currentStyle.characteristics.map(
                                      (char, idx) =>
                                        _jsx(
                                          ...
                                          {
                                            className:
                                              "text-xs px-2 py-1 bg-white/70 rounded-full",
                                            children: char,
                                          },
                                          idx,
                                        ),
                            ...
                            analysis.currentStyle.strengths.length > 0 &&
                              _jsxs("div", {
                                children: [
                                  _jsx("p", {
                                    className:
                                      "text-sm font-medium text-green-700 mb-1",
                                    children: "\u2705 \uAC15\uC810",
                                  }),
                                  _jsx("ul", {
                            ...
                            analysis.currentStyle.weaknesses.length > 0 &&
                              _jsxs("div", {
                                children: [
                                  _jsx("p", {
                                    className:
                                      "text-sm font-medium text-orange-700 mb-1",
                                    children: "\uD83D\uDCAD \uAC1C\uC120\uC810",
                                  }),
                                  _jsx("ul", {
                                    className: "text-xs space-y-0.5",
                            ...
                            _jsxs(
                              "div",
                              {
                                ...
                                children: [
                                  _jsxs("h4", {
                                    className:
                                      "font-medium text-sm mb-2 text-[#F093B0]",
                                  ...
                                  rec.examples.length > 0 &&
                                    _jsxs("div", {
                                      children: [
                                        ...
                                        _jsx("div", {
                                          className: "space-y-1",
                                          children: rec.examples.map(
                                            (example, exIdx) =>
                                              _jsxs(
                                                "div",
                                                {
                                                  className:
                                                    "text-xs bg-white p-2 rounded-lg italic text-gray-600",
                                                  children: ['"', example, '"'],
                                                },
                                                exIdx,
                                              ),
        ...
        _jsx("div", {
          ...
          children: _jsx("button", {
            onClick: onClose,
            className:
              "w-full py-3 bg-[#F093B0] text-white rounded-xl font-medium hover:bg-[#E580A0] transition-colors",
            children: "\uD655\uC778",
          }),
        }),
      ],
