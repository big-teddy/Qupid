...
// @qupid/core Screen type might be "chat" | "dashboard" | "profile" etc.
// Check packages/core/src/types.ts if "Screen" is exported, otherwise define or use string for now if unsure.
// Based on previous imports, Screen is imported from @qupid/core.
...
const PersonaCard: React.FC<{ persona: Persona; onSelect: () => void }> = ({
  persona,
  onSelect,
}) => {
  return (
    ...
    >
      ...
      <div className="ml-4 flex-1 flex flex-col">
        <div className="flex justify-between items-start">
          <div>
            <p className="font-bold text-lg text-[#191F28]">
          ...
          <p className="font-bold text-sm text-[#0AC5A8]">
        ...
        <div className="mt-2 flex flex-wrap gap-1.5">
          {persona.tags.map((tag) => (
            <span
              key={tag}
              className="px-2 py-0.5 bg-[#EBF2FF] text-[#4F7ABA] text-xs font-medium rounded-md"
            >
              #{tag}
            </span>
          ))}
    ...
    <div className="flex flex-col h-full w-full bg-[#F9FAFB]">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            <button className="p-2 rounded-full hover:bg-gray-100 transition-colors">
              <SearchIcon className="w-6 h-6 text-[#191F28]" />
            </button>
            <button className="p-2 rounded-full hover:bg-gray-100 transition-colors">
              <SettingsIcon className="w-6 h-6 text-[#191F28]" />
            </button>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-6 pb-24">
        ...
        {favoritePersonas.length > 0 && (
          <section>
            <h2 className="text-lg font-bold text-[#191F28] mb-3 px-1">
              ⭐ 즐겨찾는 AI
            </h2>
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <button
                onClick={() => {
                  ...
                  navigate("/persona/custom", { state: { category: "dating" } });
                }}
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <button
                onClick={() => {
                  ...
                  navigate("/persona/custom", { state: { category: "work" } });
                }}
                disabled={isGeneratingPersonas}
                className="px-3 py-1 text-xs font-bold text-white rounded-full transition-all hover:scale-105 disabled:opacity-50"
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <button
                onClick={() => {
                  ...
                  navigate("/persona/custom", { state: { category: "hobby" } });
                }}
                disabled={isGeneratingPersonas}
                className="px-3 py-1 text-xs font-bold text-white rounded-full transition-all hover:scale-105 disabled:opacity-50"
                    ...
                    >
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="flex-1">
                          <h3 className="font-bold text-base mb-1 text-[#191F28]">
                            {persona.name}
                          </h3>
                          ...
                          <div className="flex flex-wrap gap-1 mb-2">
                            {persona.tags
                              ...
                              .map((tag: string, tagIndex: number) => (
                                <span
                                  key={tagIndex}
                                  className="px-2 py-1 text-xs bg-[#F093B0] text-white rounded-full"
                                >
                                  {tag}
                                </span>
                              ))}
                    ...
                    <div className="p-4 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-500 mb-2">
                          {searchedPersonas.length - 3}명의
                          <br />더 많은 AI 친구들
                        </p>
                        <button
                          onClick={() => {
                            Logger.info("🔄 전체 AI 친구 보기");
                            navigate("/home", { state: { tab: "personas" } });
                          }}
        ...
        <section>
          <button
            ...
            className="w-full p-4 bg-white rounded-2xl border border-dashed border-[#B794F6] flex items-center justify-center text-[#B794F6] font-bold hover:bg-[#F7F4FF] transition-all hover:shadow-md hover:border-[#9B7FE5]"
          >
