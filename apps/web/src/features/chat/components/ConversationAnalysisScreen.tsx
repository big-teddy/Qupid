...
const ConversationAnalysisScreen: React.FC<ConversationAnalysisScreenProps> = ({
  analysis,
      ...
      <main className="flex-1 overflow-y-auto px-5 pb-28">
        <section className="p-6 flex flex-col items-center bg-white rounded-2xl border border-[#F2F4F6] shadow-lg animate-scale-in">
          ...
          <div className="mt-2 text-center">
            <span className="px-3 py-1 bg-[#0AC5A8] text-white rounded-full font-bold text-sm">
              Good!
            </span>
          </div>
          <p className="mt-4 text-xl font-bold text-center text-[#191F28]">
            {analysis.feedback}
          </p>
        </section>
