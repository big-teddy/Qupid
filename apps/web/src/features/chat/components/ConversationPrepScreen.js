...
const ConversationPrepScreen = ({ partner, onStart, onBack }) => {
  ...
  const tips = [
    "자기소개로 시작해보세요",
    `공통 관심사(${isPersona(persona) ? persona.tags?.join(", ") || "영화, 음악" : "대화"})를 물어보세요`,
    "상대방 이야기에 관심을 보여주세요",
    "긴장하지 마세요, 연습이니까요!",
  ];
  return _jsxs("div", {
    className: "flex flex-col h-screen w-full bg-white animate-fade-in",
    children: [
      _jsx("header", {
      ...
      _jsxs("main", {
        ...
        children: [
          ...
          _jsxs("div", {
            className: "mt-8 p-6 bg-white border border-[#E5E8EB] rounded-2xl",
            children: [
              _jsx("h2", {
          ...
          _jsxs("div", {
            className: "mt-4 p-5 bg-[#FDF2F8] rounded-2xl",
            children: [
              _jsx("h2", {
                className: "text-lg font-bold text-[#191F28]",
                children: "\uD83D\uDCA1 \uCCAB \uB300\uD654 \uD301",
              ...
              _jsx("ul", {
                className: "mt-3 list-disc list-inside space-y-1.5",
                children: tips.map((tip, i) =>
                  _jsx(
                    "li",
                    {
                      className: "text-sm text-[#DB7093] font-medium",
                      children: tip,
                    },
                    i,
                  ),
          ...
          _jsxs("div", {
            className: "mt-4 p-5 bg-[#EBF2FF] rounded-2xl",
            children: [
              _jsx("h2", {
                className: "text-lg font-bold text-[#191F28]",
                children:
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("div", {
                ...
                children: _jsx("p", {
                  className: "text-xs text-[#191F28] leading-relaxed",
                  children:
                    selectedMode === "normal"
      ...
      _jsx("footer", {
        ...
        children: _jsxs("button", {
          ...
          children: [
            selectedMode === "normal" ? "👋 일반 모드로" : "💕 연인 모드로",
            " \uB300\uD654 \uC2DC\uC791\uD558\uAE30",
          ],
        }),
      }),
