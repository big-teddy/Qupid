...
export function ProfileCompletenessCard({
      ...
      children: [
        ...
        nextReward &&
          _jsxs("span", {
            ...
            children: ["\uB2E4\uC74C: ", nextReward.split("(")[0]],
          }),
      ],
    });
  }
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        className: `p-4 bg-gradient-to-r ${LEVEL_COLORS[level]} text-white`,
        children: [
          _jsxs("div", {
          ...
          _jsx("div", {
            className: "mt-3 h-2 bg-white/30 rounded-full overflow-hidden",
            children: _jsx("div", {
              className:
      ...
      _jsxs("div", {
        ...
        children: [
          nextReward &&
            _jsxs("div", {
              className:
                "mb-4 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl",
              children: [
                _jsx("p", {
                  ...
                  children: [
                    ...
                    incompleteItems.length > 3 &&
                      _jsxs("span", {
                        ...
                        children: ["+", incompleteItems.length - 3, "\uAC1C"],
                      }),
                  ],
                }),
              ],
...
export function MiniProfileProgress({ completeness, onClick }) {
  return _jsxs("button", {
    ...
    children: [
      _jsx("span", { children: LEVEL_ICONS[completeness.level] }),
      _jsx("div", {
        className:
          "w-16 h-1.5 bg-gray-200 dark:bg-gray-600 rounded-full overflow-hidden",
        children: _jsx("div", {
      ...
      _jsxs("span", {
        ...
        children: [completeness.totalScore, "%"],
      }),
    ],
  });
}
