...
export function QuickPersonalityCheck({
  ...
  return _jsxs("div", {
    className:
      "flex flex-col min-h-screen bg-gradient-to-b from-purple-50 to-white dark:from-gray-900 dark:to-gray-800",
    children: [
      _jsxs("div", {
        ...
        children: [
          ...
          _jsx("div", {
            ...
            children: questionsToDisplay.map((_, idx) =>
              _jsx(
                "div",
                {
      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsx("h2", {
            className:
              "text-2xl font-bold text-center text-gray-800 dark:text-white mb-2",
      ...
      _jsx("div", {
        ...
        children: _jsx("button", {
          ...
          className:
            "text-sm text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors",
          children: "\uB098\uC911\uC5D0 \uD560\uAC8C\uC694",
        }),
      }),
    ],
