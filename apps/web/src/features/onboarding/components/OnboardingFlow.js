...
const OnboardingHeader = ({ onBack, progress, title, questionNumber }) =>
  _jsxs("div", {
      ...
      title &&
        _jsxs("div", {
          ...
          children: [
            questionNumber &&
              _jsx("p", {
                className: "text-lg font-bold text-[#F093B0]",
                children: questionNumber,
              }),
            _jsx("h1", {
              className: "text-3xl font-bold leading-tight text-[#191F28]",
              children: title,
            }),
          ],
        }),
...
const FixedBottomButton = ({ onClick, disabled, children }) =>
  _jsx("div", {
    ...
    children: _jsx("button", {
      ...
      disabled: disabled,
      className:
        "w-full h-14 text-white text-lg font-bold rounded-xl transition-colors duration-300 disabled:bg-[#F2F4F6] disabled:text-[#8B95A1]",
      style: {
...
const CheckableCard = ({ icon, title, subtitle, checked, onClick }) =>
  _jsxs("button", {
    onClick: onClick,
    ...
    children: [
      icon && _jsx("div", { className: "text-3xl mr-4", children: icon }),
      _jsxs("div", {
        className: "flex-1",
        children: [
          _jsx("p", {
      ...
      _jsx("div", {
        className: `w-6 h-6 rounded-full flex items-center justify-center border-2 transition-all duration-200 ${checked ? "bg-[#F093B0] border-[#F093B0]" : "border-[#E5E8EB]"}`,
        children:
          checked && _jsx(CheckIcon, { className: "w-4 h-4 text-white" }),
      }),
    ],
  });
...
const IntroScreen = ({ onNext, progress }) => {
  ...
  return _jsxs("div", {
    className: "flex flex-col h-full w-full animate-fade-in p-6",
    children: [
      _jsx("header", {
        className:
          "absolute top-4 left-6 right-6 h-14 flex items-center justify-center z-10",
      ...
      _jsxs("main", {
        className: "flex-1 flex flex-col justify-center -mt-14",
        children: [
          _jsxs("h1", {
            className:
              "text-3xl font-bold leading-tight animate-scale-in text-[#191F28]",
            children: [
              _jsx("span", {
                className: "text-[#F093B0]",
                children: "3\uAC1C\uC6D4 \uD6C4,",
              }),
              _jsx("br", {}),
              "\uC790\uC2E0 \uC788\uAC8C \uB300\uD654\uD558\uB294",
            ...
            children: [
              ...
              _jsxs(
                "div",
                {
                  ...
                  children: [
                    _jsx("span", {
                      className: "text-lg mr-3 text-[#0AC5A8]",
                      children: "\u2713",
                    }),
                    _jsx("p", {
                      className: "text-lg font-medium text-[#191F28]",
                      children: text,
                    }),
                  ],
                },
...
const GenderSelectionScreen = ({ onNext, onBack, progress }) => {
  ...
  return _jsxs("div", {
    className: "flex flex-col h-full w-full animate-fade-in p-6",
    children: [
      _jsx(OnboardingHeader, { onBack: onBack, progress: progress }),
      _jsxs("main", {
      ...
      _jsx(FixedBottomButton, {
        ...
        disabled: !selected,
        children: selected ? "다음 단계로" : "성별을 선택해주세요",
      }),
    ],
  });
};
    ...
    children: [
      ...
      _jsxs("main", {
        ...
        children: [
          ...
          _jsx("p", {
            className: "text-base mt-2 text-[#8B95A1]",
    ...
    children: [
      ...
      _jsxs("main", {
        ...
        children: [
          ...
          _jsx("div", {
            className: "mt-8 flex flex-wrap gap-x-2 gap-y-3",
            children: INTERESTS.map((interest) => {
              ...
              return _jsxs(
                "button",
                {
                  ...
                  children: [
                    isSelected &&
                      _jsx("span", { className: "mr-1.5", children: "\u2713" }),
                    interest,
                  ],
                },
                interest,
...
const CompletionScreen = ({ onComplete, profile, progress }) => {
  ...
  return _jsxs("div", {
    className: "flex flex-col h-full w-full animate-fade-in p-6",
    children: [
      _jsx(OnboardingHeader, { progress: progress }),
      _jsxs("main", {
        className: "flex-1 flex flex-col justify-center -mt-14",
        children: [
          _jsx("div", {
            className:
              "w-32 h-32 rounded-full bg-[#F093B0] flex items-center justify-center animate-scale-in self-center",
            children: _jsx(CheckIcon, { className: "w-16 h-16 text-white" }),
          }),
          _jsxs("h1", {
          ...
          _jsx("div", {
            className:
              "mt-6 p-6 bg-[#F9FAFB] rounded-2xl border border-[#E5E8EB]",
            children: _jsxs("ul", {
              className: "space-y-3",
              children: [
                _jsxs("li", {
                ...
                _jsxs("li", {
                  ...
                  children: [
                    ...
                    _jsx("span", { children: profile.experience }),
                  ],
                }),
                _jsxs("li", {
                  className: "flex justify-between",
...
export const OnboardingFlow = ({ onComplete, onLogin, skipIntro = false }) => {
  ...
  const handleFinalComplete = useCallback(async () => {
    try {
      ...
      if (result?.id) {
        // User ID stored in localStorage by createUser mutation
      ...
      if (!tutorialPersona) {
        ...
        const partnerGender =
          profile.user_gender === "male" ? "female" : "male";
        tutorialPersona = {
          id: "tutorial-persona-generated",
          name: partnerGender === "female" ? "김서현" : "박지훈",
          age: 25,
          gender: partnerGender,
          avatar: getConsistentAvatar(
            partnerGender === "female" ? "김서현" : "박지훈",
            partnerGender,
          ),
          personality: partnerGender === "female" ? "ENFP" : "ISFJ",
          occupation:
            partnerGender === "female" ? "초등학교 교사" : "소프트웨어 개발자",
  ...
  }, [createUser, onComplete, profile, setUser, generatePersona]);
  ...
  const generateTutorialPersona = async (profile) => {
    try {
      ...
      const fallbackPersona = {
        ...
        values: ["가정 지향", "성장 지향"],
        communicationStyle:
          partnerGender === "female" ? "감성적, 공감적" : "논리적, 신중함",
        ...
        speechPattern:
          partnerGender === "female"
            ...
            : "친근한 말투, 신중함",
        lifestyle:
          partnerGender === "female" ? "밖돌이, 사교적" : "집순이, 독립적",
  ...
  const renderStep = () => {
    ...
    switch (step) {
      case 0:
        return _jsx(IntroScreen, {
          onNext: nextStep,
          progress: currentProgress,
        });
      case 1:
        return _jsx(GenderSelectionScreen, {
          onNext: handleGenderSelect,
          onBack: prevStep,
          progress: currentProgress,
        });
      case 2:
        return _jsx(SurveyScreen, {
      ...
      case 4:
        // Completion screen
        return _jsx(CompletionScreen, {
          onComplete: handleFinalComplete,
          profile: profile,
          progress: TOTAL_ONBOARDING_STEPS,
        });
      default:
        return _jsx(IntroScreen, { onNext: nextStep, progress: 1 });
    }
  };
  ...
  if (step === TOTAL_ONBOARDING_STEPS) {
    return _jsx("div", {
      className:
        "h-full w-full flex items-center justify-center relative bg-white",
      children: _jsx(CompletionScreen, {
        onComplete: handleFinalComplete,
        profile: profile,
        progress: TOTAL_ONBOARDING_STEPS,
      }),
