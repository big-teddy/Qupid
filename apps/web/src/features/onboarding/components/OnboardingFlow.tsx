...
// --- Onboarding Screens ---
const IntroScreen: React.FC<{ onNext: () => void; progress: number }> = ({
  onNext,
  progress,
}) => {
...
export const OnboardingFlow: React.FC<{
  ...
  const renderStep = () => {
    ...
    switch (step) {
      case 0:
        return <IntroScreen onNext={nextStep} progress={currentProgress} />;
      case 1:
        return (
      ...
      default:
        return <IntroScreen onNext={nextStep} progress={1} />;
    }
  };
