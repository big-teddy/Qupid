      ...
      _jsxs("button", {
        ...
        children: [
          ...
          unreadCount > 0 &&
            _jsx("span", {
              className:
                "absolute -top-1 -right-1 w-5 h-5 bg-[#F093B0] text-white text-xs rounded-full flex items-center justify-center",
      ...
      isOpen &&
        _jsxs(_Fragment, {
          children: [
            ...
            _jsxs("div", {
              className:
                "absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-xl z-50 max-h-96 overflow-hidden",
              children: [
                _jsxs("div", {
                              ...
                              children: _jsxs("div", {
                                ...
                                children: [
                                  ...
                                  !notification.isRead &&
                                    _jsx("div", {
                                      className:
                                        "w-2 h-2 bg-[#F093B0] rounded-full mt-2",
                                    }),
                                ],
                              }),
                            },
                ...
                notifications.length > 0 &&
                  _jsx("div", {
                    ...
                    children: _jsx("button", {
                      ...
                      className:
                        "w-full text-center text-sm text-[#F093B0] font-medium hover:underline",
                      children: "\uBAA8\uB4E0 \uC54C\uB9BC \uBCF4\uAE30",
                    }),
                  }),
              ],
