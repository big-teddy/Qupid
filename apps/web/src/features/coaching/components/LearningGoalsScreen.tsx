  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#F9FAFB]">
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <section>
          <h2 className="font-bold text-lg px-2 text-[#191F28]">
            새로운 목표 선택
          </h2>
            ...
            {goalOptions.map((opt) => (
              ...
              >
                ...
                {selectedGoal === opt.key && (
                  <div className="absolute top-3 right-3 w-5 h-5 bg-[#F093B0] rounded-full flex items-center justify-center text-white text-xs">
                    ✓
                  </div>
                )}
              </button>
        ...
        <section>
          ...
          <div className="mt-2 p-5 bg-white rounded-2xl border border-[#F2F4F6] space-y-4">
            ...
            <div>
              <label className="font-medium">
                대화 시간:{" "}
                <span className="font-bold text-[#F093B0]">{customTime}분</span>
              </label>
              <input
                type="range"
                min="10"
        ...
        <section className="p-4 rounded-lg bg-[#EBF2FF]">
          ...
          <p className="mt-1 text-sm text-[#3A5A8A] leading-relaxed">
            "일 3회 대화 목표로 꾸준히 연습하면 4주 후 대화 점수 +25점 향상, 8주
            후 고급 레벨 달성이 예상돼요!"
          </p>
        </section>
      </main>
