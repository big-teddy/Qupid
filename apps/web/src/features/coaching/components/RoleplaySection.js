    ...
    children: [
      _jsx("div", {
        ...
        children: _jsxs("div", {
          children: [
            _jsx("h2", {
              className: "text-lg font-bold text-[#191F28] mb-1",
              children: "\uC2E4\uC804 \uB864\uD50C\uB808\uC789 \uD83C\uDFAD",
            }),
            _jsx("p", {
      ...
      _jsx("div", {
        className:
          "flex space-x-3 overflow-x-auto pb-2 -mx-4 px-4 scrollbar-hide",
        children: scenarios.map((scenario) =>
          _jsxs(
            "div",
            {
              ...
              className:
                "flex-shrink-0 w-64 p-4 bg-white rounded-xl border border-[#F2F4F6] cursor-pointer transition-all hover:shadow-lg hover:border-purple-300 hover:-translate-y-0.5",
              children: [
                _jsxs("div", {
                ...
                _jsx("p", {
                  className: "text-sm text-[#8B95A1] line-clamp-2",
