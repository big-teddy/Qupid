      ...
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          <Route
            path="/my"
            element={
              <Pages.MyTabScreen isGuest={isGuest} onLogout={handleLogout} />
            }
          />
        </Route>
        ...
        <Route
          ...
          element={
            <Pages.PersonaDetailScreen
              ...
              onBack={() =>
                navigate(sessionData?.isTutorial ? "/home" : "/chat")
              }
              onStartChat={(persona) => {
        ...
        <Route
          ...
          element={
            <Pages.ChatScreen
              ...
              conversationMode={
                (sessionData?.conversationMode as ConversationMode) || "normal"
              }
        ...
        <Route
          ...
          element={
            <Pages.PerformanceDetailScreen onBack={() => navigate("/home")} />
          }
        />
        <Route
          path="/analytics/export"
          element={
            <Pages.DataExportScreen onBack={() => navigate("/settings")} />
          }
        />
        <Route
          path="/my/design"
