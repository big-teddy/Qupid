    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-1 relative">
            ...
            {showNotifications && (
              <div className="absolute top-12 right-0 w-80 z-50 animate-fade-in-up">
                <NotificationList
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-4 pb-24">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <button
                ...
                className="mt-2 h-9 px-4 text-sm font-bold text-white rounded-lg"
        ...
        <div
          ...
          className="p-5 bg-white rounded-2xl border cursor-pointer transition-all hover:shadow-lg hover:border-[#0AC5A8]"
          style={{ borderColor: "#F2F4F6" }}
        >
          <div className="flex justify-between items-center">
            <h2 className="font-bold text-lg">📊 이번 주 성장</h2>
            <div
              className="flex items-center text-sm font-medium transition-transform hover:translate-x-1"
              style={{ color: "#4F7ABA" }}
            >
          ...
          <div className="mt-2 flex items-baseline space-x-2">
            <p className="text-3xl font-bold" style={{ color: "#0AC5A8" }}>
              ...
              {displayPerformanceData.scoreChange}점 향상
            </p>
            ...
            {dynamicPersonas.length < 3 && (
              <div className="flex items-center justify-center p-3 rounded-lg border border-dashed border-[#F093B0]">
                <div className="text-center">
                  <p className="text-sm text-[#F093B0] font-semibold">
                    더 많은 AI 친구를 만나보세요!
                  </p>
                  <button
                    onClick={() => navigate("/chat")}
        ...
        {recentBadge && (
          ...
          >
            ...
            <div className="flex-1 ml-3">
              ...
              <p className="font-medium text-sm" style={{ color: "#8B95A1" }}>
                {recentBadge.name}
              </p>
            </div>
            <button
              className="h-8 px-3 text-xs font-bold text-white rounded-lg transition-transform hover:scale-105"
